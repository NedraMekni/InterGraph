...
if __name__ == "__main__":
    ...
    graph_dict, cache = biograph_from_file(ROOT_PATH + "/PDB/data/")
    ...
    y_dict = data_activities_from_file(
        ROOT_PATH + "/csv", ROOT_PATH + "/csv/y_preprocessed.csv"
    )
    ...
    global_G = build_graph_dict(graph_dict, y_dict, ROOT_PATH)
